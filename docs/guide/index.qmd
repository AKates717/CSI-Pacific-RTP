...
![](../../images/Cover1.jpeg){fig-align="right" width="173"}
:::
:::::
...
::: {.column width="50%"}
![](../../images/ath-centred.png){.lightbox fig-align="center" width="366"}
:::
...
::: phase-nav
[Pre-Op: Injury recovery & readiness for surgery](preop.qmd){.phase-nav .btn .phase-preop}
:::
...
::: phase-nav
[Phase 3: Dynamic Neuromuscular Performance](#phase-3-running-agility-and-landings){.btn .phase-3}
:::
...
::: phase-nav
[Phase 5: Return to Performance](#phase-5-prevention-of-re-injury){.btn .phase-5}
:::
