...
![Example weekly schedule for Phase 1 ACL rehabilitation. Times are shown as an example of how each day might be structured.](images/phase3_weekly_sched.png){#fig-3 .lightbox fig-align="left"}
...
```{r}
#| label: fig-4
#| fig-cap: "Example schedule for the introduction of dynamic tasks in Phase 3 ACL rehabilitation.  Week numbers are for display purposes only and will vary for each unique individual.  Plyo = Plyometrics; COD = Change of direction"
