...
During phase 3, maximal strength training will remain an important part of the program, and will continue to build in intensity.

The introduction of dynamic movements during this phase should roughly follow this task-based progression @buckthorpe2020a seen in @fig-3. The actual time-frame of introduction is only an estimate and is subject to change based on progression through Phase and RTR criteria.
