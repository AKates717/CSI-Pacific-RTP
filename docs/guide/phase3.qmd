...
At this stage of the rehab, it is likely that the athlete will meet criteria to begin a progressive return to running. The best evidence available to aid in the return-to-run decision comes from a 2018 scoping review which extracted data from 201 studies, each reporting at least one criterion for permitting adult patients to commence running post-ACLR @rambaud2018.
