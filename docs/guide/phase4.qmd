...
![Example weekly schedule for Phase 4 ACL rehabilitation, adapted from Buckthorpe 2019 @buckthorpe2019a. *OFR = On-field rehabilitation; NM = Neuromuscular; UB = Upper body; LB = Lower body; ESD = Energy system development*](images/phase4_weekly_sched.png){#fig-5 .lightbox alt="Example weekly schedule for Phase 1 ACL rehabilitation. Times are shown as an example of how each day might be structured." fig-align="left"}
