...
Provided that the athlete has tolerated stage 2 and 3 plyometric activities well, at this time they may progress to higher intensity exercises such as maximal unilateral plyometrics, multiplanar unilateral movements (e.g. frontal and rotational plane) and reactive field-based movements (e.g. responding to perturbations; unplanned tasks). Incorporating high intensity exercises, such as a single leg drop jump are important during rehab, in order to uncover performance deficits that might not be present in more simple exercises like a single leg hop for distance [@king2018].

As will be seen in the next section, plyometric activities may take place in the gym or in field-based situations.
