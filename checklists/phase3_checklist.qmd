...
htmltools::div(
  ...
  navset_card_tab(
    ...
    nav_panel(
      "TBDL",
      barplot_one_var(outcomes_raw_phase3, "TrapBar Deadlift", "kg")
    ),
    nav_panel(
      "SL Rise",
      plot_ind_phase_outcomes(outcomes_raw_phase3, "Single Leg Rise")
    )
  )
)
...
htmltools::div(
  ...
  navset_card_tab(
    ...
    nav_panel(
      "Height",
      stat_summary_plot(post_cmj, flight_height_tov, "#DA2D33", post_cmj$flight_height_tov, "Flight Height - TOV")
    ),
    nav_panel(
      "RSImod",
      stat_summary_plot(post_cmj, rs_imod, "dodgerblue4", post_cmj$rs_imod, "RSI mod")
    ),
    nav_panel(
      "BA%",
      BA_plot_percent(post_cmj, balng, basht, "orange", "dodgerblue3")
    ),
    nav_panel(
      "BA-Mag (Con)",
      BA_plot_magnitude(post_cmj, sht_left, sht_right, "red", "black", post_cmj$sht_left, post_cmj$sht_right)
    )
  )
)
...
htmltools::div(
  ...
  navset_card_tab(
    full_screen = TRUE,
    title = htmltools::tags$span(style = "font-weight:700; font-size:1.2rem;", "Drop and Stick"),
    nav_panel(
      "TTS",
      stat_summary_plot4(post_dns, time_to_95_percent_bw, "#5C5C6B", post_dns$time_to_95_percent_bw, "")
    ),
    nav_panel(
      "rPLF",
      stat_summary_plot4(post_dns, landing_n_kg, "#5C5C6B", post_dns$landing_n_kg, "")
    ),
    nav_panel(
      "BA%",
      BALand_plot_percent(post_dns, baland, "")
    )
  )
)
