...
**`r athlete_name`'s** progress towards these goals will be assessed via the criteria seen below.
...
htmltools::div(
  ...
  navset_card_tab(
    ...
    nav_panel(
      "Quads",
      plot_iso_magnitude(iso_joint2, "Quads")
    ),
    nav_panel(
      "Hams",
      plot_iso_magnitude(iso_joint2, "Hamstrings")
    ),
    nav_panel(
      "TBDL",
      barplot_one_var(outcomes_raw_phase2, "TrapBar Deadlift", "kg")
    ),
    nav_panel(
      "SL Rise",
      plot_ind_phase_outcomes(outcomes_raw_phase2, "Single Leg Rise")
    ),
    nav_panel(
      "SL Bridge",
