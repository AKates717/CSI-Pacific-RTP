...
<i class="fa-solid fa-bars-progress"></i> **Phase:** 2 <br> 
{{< fa solid dumbbell size=1x >}} *Strength & NM Control* <br> 
<i class="fa-solid fa-battery-three-quarters"></i> **Phase Progress:** 50%

<i class="fa-solid fa-briefcase-medical"></i> **Injury:** `{r} Rehab_Info$primary_injury` <br> 
<i class="bi bi-person-arms-up"></i> **Limb:** `{r} Rehab_Info$limb` <br> 
<i class="fa-solid fa-calendar-day"></i> **Date of Surgery:** `{r} surgery_date` <br> 
<i class="fa-solid fa-file-medical"></i> **Type of Surgery:** `{r} Rehab_Info$type_of_surgery`
...
### Row - Daily Monitoring {height="50%"}
...
### Row - Phase Criteria Summary {height="50%"}

::: {.card .border-0 fill="false"}
```{r}
#| label: phase_criteria_summary
...
gt(table_df) |>
  ...
  ak_gt_theme3() |>
  cols_align(align = "center", columns = c(Criterion, Score)) |>
  tab_options(
    table_body.hlines.style = "solid",
    table_body.hlines.width = px(1),
    data_row.padding = px(6)
