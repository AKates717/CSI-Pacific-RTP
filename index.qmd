...
<i class="fa-solid fa-calendar-day"></i> **Day:** `{r} Days` <br> <i class="fa-solid fa-calendar-week"></i> **Week:** 6
...
**Injury:** `{r} Rehab_Info$primary_injury` <br>
**Limb:** `{r} Rehab_Info$limb` <br>
**Date of Surgery:** `{r} Rehab_Info$date_of_surgery` <br>
**Type of Surgery:** `{r} Rehab_Info$type_of_surgery`

## Column {width = "33%"}

::: {.card title="Today's Summary" fill="false"}
...
p <- ggplot(wellness, aes(x = date, y = swelling)) +
